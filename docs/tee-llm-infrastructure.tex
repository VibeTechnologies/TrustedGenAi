...
\author[1]{VibeTechnologies Research}
\affil[1]{\texttt{research@vibebrowser.app}}
...
\subsection{GPU TEE Configuration}

For production workloads requiring higher throughput, we provide configurations for NVIDIA H100 Confidential Computing:

\begin{table}[H]
\centering
\caption{GPU TEE Configuration}
\begin{tabular}{@{}ll@{}}
\toprule
\textbf{Parameter} & \textbf{Value} \\
\midrule
